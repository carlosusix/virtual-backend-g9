...
fruta = frutas[0]
fruta='platano'
# para poder ver en que posicion de la memoria esta siendo ubicada una variable se usa el método id()
...
# las variables que son colecciones de datos como listas, tuplas y dicicionarios son variables mutables
